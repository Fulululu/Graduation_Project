...
//20171108 add MT_rx_buffer size
#define MT_RX_BUF_SIZE   15
...
//20171108 add MT_rx_buffer
uint8 MT_RX_Buffer[MT_RX_BUF_SIZE];
uint16 rxLen;
...
#endif
  //20171108 add callback
  uartConfig.callBackFunc         = MT_UartRXCB;
